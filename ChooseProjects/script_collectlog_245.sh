...
cp $prefix$line$infix2$line$infix${line2%% *}$infix2$line$infix2"pitest_historyfirst_log.txt" $todir$line$infix2$line$infix${line2%% *}$infix2
cp $prefix$line$infix2$line$infix${line2%% *}$infix2$line$infix2"pitest_historysecond_log.txt" $todir$line$infix2$line$infix${line2%% *}$infix2
cp -arf $prefix$line$infix2$line$infix${line2%% *}$infix2$line$fromdir"pit-reports/" $todir$line$infix2$line$infix${line2%% *}$infix2
cp -arf $prefix$line$infix2$line$infix${line2%% *}$infix2$line$fromdir"pitHistory1.txt" $todir$line$infix2$line$infix${line2%% *}$infix2
cp -arf $prefix$line$infix2$line$infix${line2%% *}$infix2$line$fromdir"pitHistory2.txt" $todir$line$infix2$line$infix${line2%% *}$infix2
